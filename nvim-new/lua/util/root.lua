-- Allows user to call Util.root(), which is a sort of alias for Util.root.get()
...
-- TODO: Figure out a get_clients alternative
...
function M.info()
  ...
  lines[#lines + 1] = '```'
  Util.info(lines, { title = 'Editor Root Path' })
