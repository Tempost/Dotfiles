...
M.on_attach = function(client, bufnr)
	...
	if client.server_capabilities.documentHighlightProvider then
		...
		vim.api.nvim_set_hl(0, "LspReferenceRead", { bg = colors.medium_gray, bold = true })
		vim.api.nvim_set_hl(0, "LspReferenceText", { bg = colors.medium_gray, bold = true })
		vim.api.nvim_set_hl(0, "LspReferenceWrite", { bg = colors.medium_gray, bold = true })
